...
from app.services.schema_maintenance import ensure_quiz_question_topic_relation, ensure_topic_progress_table, ensure_topic_quiz_attempts_table
...
async def ensure_database_tables():
    async with engine.begin() as conn:
        ...
        await ensure_topic_progress_table(conn)

    ...
    <div className="flex flex-col gap-4 xl:flex-row xl:items-start xl:justify-between xl:gap-6">
      <div className="min-w-0 flex-1">
        <h2 className="font-headline text-3xl font-bold tracking-tight text-primary">
          ...
          <Badge
            variant="secondary"
            className={`${isLiveMode ? "bg-emerald-100 text-emerald-700" : "bg-amber-100 text-amber-700"} ml-2`}
          >
        ...
        <div className="mt-3 mb-2 flex flex-wrap items-center gap-3 text-xs font-medium">
      ...
      <div className="flex shrink-0 flex-wrap items-end gap-3 xl:justify-end xl:self-start flex-col ">
        <Button asChild variant="secondary" className="order-4 shrink-0 xl:order-none">

      ...
      <div className="flex flex-wrap items-center justify-end gap-3">
        <div className="mr-2 flex items-center gap-2">
          ...
          <select
            ...
            className="min-w-48 rounded-md border border-slate-300 bg-slate-100 px-3 py-2 text-sm text-slate-700 outline-none focus:ring-2 focus:ring-primary/50"
        ...
        <Badge
          variant="secondary"
          className={isLiveMode ? "bg-emerald-100 text-emerald-700" : "bg-amber-100 text-amber-700"}
        >
